...
function Signup() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:3001/register', { name, email, password, gender, photo })
      .then(result => {
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-5 flex items-center justify-between">
                <label htmlFor="gender" className='text-headingColor font-bold text-base leading-7'>
                  Gender:
                  <select
                    name="gender"
